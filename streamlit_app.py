...
# ❌ 예전 코드: retriever = vectorstore.as_retriever(...)
# 새 버전에서는 retriever.get_relevant_documents()가 없어져서 에러났던 거야


# ---------------------------------------------------------
# 3. RAG 검색 (vectorstore에서 바로 검색)
# ---------------------------------------------------------
def search_clause(query: str) -> str:
    # 🔥 새 코드: similarity_search를 직접 사용
