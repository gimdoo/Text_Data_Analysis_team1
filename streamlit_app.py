...
# --------------------------------------------------------------------------
# 3. FAISS Vectorstore 생성 — precomputed embeddings 사용
# --------------------------------------------------------------------------
@st.cache_resource
def create_vectorstore(_docs, _vectors):
    ...
    # 🔥 핵심: precomputed embedding mode 강제 활성화
    vectorstore._embedding_function = None
    vectorstore._normalize_embeddings = False
...
st.markdown("""
<style>
/* 너가 넣었던 기존 CSS 그대로 유지해야 함 — 여기 생략 */
</style>
